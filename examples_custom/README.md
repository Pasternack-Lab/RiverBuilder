## A workflow for generating a River Builder channel with custom Geomorphic Variability Functions (GVFs)
...
<!-- ![Figure 1.](/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVlevels_xy.png) -->
<p align="center" width="50%">
<img width="50%" src="/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVlevels_xy.png" alt="input2">
</p>

<!-- ![Figure 2.](/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVlevels_xz.png) -->
<p align="center" width="50%">
<img width="50%" src="/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVlevels_xz.png" alt="input2">
</p>
   
3. Apply GVFs externally by imposing GVF series from RiverSTICH to the River Builder output by running RB_postprocess_custom.py (in /tools)
    - Input (/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V)
        - SRVtopo.csv
            - The main RB output (e.g., table of x, y, z coordinates of topography)
    - Output (/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V)
        - SRVtopo_thal.csv (final output)
            - Table of x, y, z coordinates of topography with custom GVFs
          
<!-- ![Figure 3.](/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVtopo_final.png) -->
<p align="center" width="50%">
<img width="50%" src="/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/SRVtopo_final.png" alt="input2">
</p>

4. Convert x, y, z points to a raster DEM by running RB_to_terrain_custom.py (in /tools)
    - Input (/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V)
        - SRVtopo_thal.csv (final output)
            - Table of x, y, z coordinates of topography with custom GVFs
    - Output (/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V)
        - SFE_Leggett_FB_V.tif 
        - SFE_Leggett_FB_V.asc
    
<!-- ![Figure 4.](/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/final_RB_terrain.png) -->
<p align="center" width="50%">
<img width="50%" src="/examples_custom/SFE_Leggett_FB_V/SFE_Leggett_FB_V/final_RB_terrain.png" alt="input2">
</p>
